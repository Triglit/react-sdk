...
/**
 * Props for OneWayLeftNode (final nodes)
 */
export interface OneWayLeftNodeProps extends NodeProps<Node<NodeData>> {
	/**
...
/**
 * One-way left node component (for final nodes)
 * These nodes only have input handles (on the left)
 *
 * @example
 * ```tsx
 * <OneWayLeftNode
 ...
 * ```
 */
export function OneWayLeftNode({
	id,
	data,
	onConfigClick,
}: OneWayLeftNodeProps) {
